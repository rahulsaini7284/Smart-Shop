...
export const userLoginAction =
  ...
  async (dispatch) => {
    try {
      ...
      const { data } = await httpGet.post("/api/users/login", {
        email,
        password,
      });
      if (data) {
...
export const userRegisterAction =
  ...
  async (dispatch) => {
    try {
      ...
      const { data } = await httpGet.post("/api/users", {
        email,
        password,
        name,
      });
...
export const userDetailsAction = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await httpGet.get(`/api/users/${id}`, config);
    dispatch({
...
export const userDeleteAction = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await httpGet.delete(`/api/users/admin/${id}`, config);
    dispatch({
...
export const adminUserDetailsAction = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await httpGet.get(`/api/users/admin/${id}`, config);
    dispatch({
